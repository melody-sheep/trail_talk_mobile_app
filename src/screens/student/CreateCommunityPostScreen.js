            ...
            <View style={styles.communityHeader}>
              ...
              <View style={styles.communityText}>
                ...
                <Text style={styles.communityCategory}>
                  {communityData?.category ? `${communityData.category.charAt(0).toUpperCase() + communityData.category.slice(1)} Community` : 'Loading...'}
                </Text>
              </View>
            </View>
          ...
          <View style={styles.section}>
            ...
            >
              <TextInput
                ...
                multiline={true}
                placeholder="Share your thoughts, questions, or announcements with the community..."
