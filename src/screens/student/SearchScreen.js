...
export default function SearchScreen({ navigation }) {
  ...
  // Mock data for suggested accounts - Replace with actual data from your database
  ...
  const filteredAccounts = suggestedAccounts.filter(account => {
    ...
    if (activeCategory === 'students') return account.role === 'student';
    if (activeCategory === 'faculty') return account.role === 'faculty';
    if (activeCategory === 'communities') return account.role === 'community';
    return true;
  });
          ...
          <View style={[
            ...
            <Text style={styles.roleText}>
              {item.role === 'student' ? 'Student' : 
               item.role === 'faculty' ? 'Faculty' : 'Community'}
            </Text>
          </View>
        </View>
      </View>
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      >
        ...
        {/* Category Chips - Using CreatePost Screen Design */}
