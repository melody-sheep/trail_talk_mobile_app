...
export default function CommunityDetailScreen({ navigation, route }) {
  ...
  const handleViewMembers = () => {
    navigation.navigate('FacultyCommunityMembers', { communityId, communityName: community?.name });
  };
  ...
  const renderPostItem = ({ item }) => (
    <CommunityPostCard post={item} userRole={community?.userRole || 'faculty'} onInteraction={(postId, field, newCount) => {
