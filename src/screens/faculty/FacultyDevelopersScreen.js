...
export const facultyTeamMembers = [
  {
    id: 1,
...
const FacultyDevelopersScreen = ({ navigation }) => {
  ...
  // FIXED: Use the exported facultyTeamMembers
  const teamMembers = facultyTeamMembers;
  ...
  // PanResponder for swipe detection - only capture when gesture is predominantly horizontal
